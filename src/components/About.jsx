    ...
    return (
        <div className="max-w-7-xl mx-auto px-4 py-8">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            <p className="text-lg mb-4">  Your one-stop destination for the best in tech, fashion, home, and more. 
            Enjoy a seamless shopping experience tailored just for you.</p>
          </div>
